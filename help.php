...
<head>
    ...
    <title>kiwi Comment trouver de l'aide</title>
</head>
...
<main class="content">
    <h1>Bienvenue dans le centre d'aide de Kiwi Comment !</h1>


    <div class="une">
        <h1>Vous avez besoin d'aide ?</h1>
        <h1>C'est bien dommage. On a pas encore de tuto sur ça.</h1>
